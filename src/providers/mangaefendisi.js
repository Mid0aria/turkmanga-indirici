...
class MangaEfendisiProvider {
    constructor() {
        this.name = "MangaEfendisi";
        this.baseUrl = "https://mangaefendisi.net";
        this.searchUrl = "https://mangaefendisi.net/wp-admin/admin-ajax.php";
    }
            ...
            $(".reading-content img, .read-container img").each(
                (_, element) => {
                    ...
                    if (imgSrc) {
                        ...
                        if (lastDotIndex > 0) {
                            const baseUrlWithoutExtension = imgSrc.substring(
                                0,
                                lastDotIndex,
                            );
                            imgSrc = baseUrlWithoutExtension + ".jpg";
                        }
                        images.push(imgSrc);
                    }
                },
...
module.exports = MangaEfendisiProvider;
