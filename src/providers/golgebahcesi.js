...
class GolgeBahcesiProvider {
    constructor() {
        this.name = "GolgeBahcesi";
        this.baseUrl = "https://golgebahcesi.com";
        this.searchUrl = "https://golgebahcesi.com/wp-admin/admin-ajax.php";
    }
...
module.exports = GolgeBahcesiProvider;
