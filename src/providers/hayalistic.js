...
class HayalisticProvider {
    constructor() {
        this.name = "Hayalistic";
        this.baseUrl = "https://hayalistic.com.tr";
        this.searchUrl = "https://hayalistic.com.tr/wp-admin/admin-ajax.php";
    }
...
module.exports = HayalisticProvider;
