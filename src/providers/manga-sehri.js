...
class MangaSehriProvider {
    constructor() {
        this.name = "Manga Sehri";
        this.baseUrl = "https://manga-sehri.net";
        this.searchUrl = "https://manga-sehri.net/wp-admin/admin-ajax.php";
    }
...
module.exports = MangaSehriProvider;
