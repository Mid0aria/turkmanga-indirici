...
class MangaOkuTRProvider {
    constructor() {
        this.name = "MangaOkuTR";
        this.baseUrl = "https://mangaokutr.com";
        this.searchUrl = "https://mangaokutr.com/wp-admin/admin-ajax.php";
    }
...
module.exports = MangaOkuTRProvider;
